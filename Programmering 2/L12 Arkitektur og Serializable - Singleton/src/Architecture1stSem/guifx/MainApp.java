package Architecture1stSem.guifx;

import Architecture1stSem.application.controller.Controller;
...
public class MainApp extends Application {
    ...
    @Override
    public void stop() {
        Controller.saveToFile(Controller.PATH, Controller.getStorage());
    }
